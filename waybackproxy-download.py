#!/usr/bin/env python3
import base64, datetime, json, lrudict, re, socket, socketserver, sys, threading, urllib.request, urllib.error, urllib.parse, os
DATE_TOLERANCE = 730
from config import *
	...
	def handle(self):
		...
		try:
			if path in pac_file_paths:
				...
				#os.system("wayback_machine_downloader -f {0} -t 20151025 -e \"{1}\"".format(effective_date, archived_url))
			...
			os.system("echo \"{0}\" >> urls.txt".format(request_url))
